...
rm(list = ls())
packages = c("readxl", "car", "rcompanion", "userfriendlyscience", "rstatix", "multcomp", "emmeans", "ggplot2", "nortest", "e1071", "onewaytests", "dplyr", "BFpack", "PMCMRplus", "dunn.test", "PMCMR", "agricolae", "openxlsx")
